...
<style>
body{
background-image: url(resources/images/bgk9.jpg);
...
<body>
	<h1 style="font-family:"Comic Sans MS", cursive, sans-serif; style="font-size:300%;" style="color:black"><center >CART LIST</center></h1>
